...
# abort to handle errors and return HTTP error codes
# Import the supplierDAO class from the supplierDAO module to handle database operations

from flask import Flask, request, jsonify, abort
from supplierDAO import supplierDAO

#Set up the Flask app and allow it to serve static files (like HTML and CSS) from the current folder
